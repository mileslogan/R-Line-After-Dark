...
public class AnimationSync : MonoBehaviour
{
    ...
    public RhythmHeckinWwiseSync wwiseSync;
    ...
    void Update()
    {
        ...
        if (TimeMS >= 0d)
        {
            secondsPerBeat = RhythmHeckinWwiseSync.secondsPerBeat;
            TimeMS = RhythmHeckinWwiseSync.GetMusicTimeInMS();
            //Start playing the current animation from wherever the current beat loop is
            animator.Play(currentState, -1, GetNormalizedLoopPosition(TimeMS));
